...
axios.get(`https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(site)}.json?access_token=pk.eyJ1Ijoiam9zZTF1c2VjaGUiLCJhIjoiY2xoOTVtOWhoMDQ1azNob2FzdXk5MXp4dSJ9.uJWmjljssJceIJ5owOKbYA&limit=1`)
.then(response => {
    // handle success
    ...
    console.log(`Latitude: ${latitude}, Longitude: ${longitude}`, encodeURIComponent(site));
